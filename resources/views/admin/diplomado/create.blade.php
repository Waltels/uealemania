...
<div class="row">
                        ...
                        <script>
                            ...
                            Toast.fire({
                            icon: "error",
                            title: "Deve incluir un título, un emisor, un numero de documento y un archivo o ya se registro el documento"
                            });
                        </script>
                        @enderror 
    <div class="col-md-6 grid-margin stretch-card mx-auto">
        <div class="card">
            <div class="card-body">
                ...
                <h6 class="text-center">Se agregara un documento de <strong>DIPLOMADO</strong>, de la Maestra o Maestro:</h6>
                <h4 class="text-center">{{auth()->user()->name}}</h4>
                <hr>
                <form action="{{ route('admin.diplomados.store') }}" method="POST" class="forms-sample" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="descripcion" class="form-control" placeholder="Título del Certificado de Diplomado">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Emisor</label>
                        <div class="col-sm-9">
                            <input type="text" name="emisor" class="form-control" placeholder="Institución emisora del Certificado de Diplomado">
                        </div>
                    </div>
                    <div class="row mb-3">
