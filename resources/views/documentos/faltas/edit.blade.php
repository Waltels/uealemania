                ...
                <form action="{{ route('documento.faltas.update', $falta) }}" method="POST" class="forms-sample">
                   @method('PUT')
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="nombre" class="form-control" value="{{$falta->name}}">
                            <input type="text" name="estado" class="form-control" id="exampleInputUsername2" value="{{$falta->estado}}" hidden>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Normativa</label>
                        <div class="col-sm-9">
                            <input type="text" name="normativa" class="form-control"  value="{{$falta->normativa}}">
                        </div>
                    </div>
