            ...
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title mb-1">datos del solicitante</h6>
                        ...
                        <form method="POST" id="faltasdoc" action="{{route('documento.faltadocentes.update',$faltadocente)}}" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf 
                            <div class="row">
                                <div class="col-sm-5">
                                    <div class="mb-3">
                                        ...
                                        <select name="docente_id"  class="form-control" aria-label="Default select example">
                                            ...
                                            @if ($docente->user->id == $faltadocente->docente->user->id)
                                            selected="selected" 
                                            @endif>{{$docente->user->name}}</option>
                                            @endforeach  
                                        </select>
                                    </div>
                                </div>
                                <div class="col-sm-5">
                                    <div class="mb-3">
                                        ...
                                        <select name="falta_id"  class="form-control" aria-label="Default select example">
                                            ...
                                            @if ($falta->id == $faltadocente->falta->id)
                                            selected="selected"     
                                            @endif>{{$falta->name}}</option>
                                            @endforeach 
                                          </select>
                                    </div>
                                </div>
                                <div class="col-sm-2">
                                    <div class="mb-3">
                                        ...
                                        <select name="mes_id"  class="form-control" aria-label="Default select example">
                                            @foreach ($mess as $mes)
                                            <option value="{{$mes->id}}"
                                            @if ($mes->id == $faltadocente->mes->id)
                                            selected="selected"     
                                            @endif>{{$mes->name}}</option>
                                            @endforeach 
                                          </select>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group flatpickr" id="flatpickr-date">
                                            <input name="fecha" type="text" class="form-control" value="{{$faltadocente->fecha}}" data-input>
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group flatpickr" id="flatpickr-date">
                                            <textarea class="form-control" name="acciones">{{$faltadocente->acciones}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="mb-3">
                                <div class="col-sm-12">
                                    ...
                                    <textarea class="form-control" name="descripcion" id="tinymceExample">{{$faltadocente->descripcion}}</textarea>
                                </div>
                            </div>
